      ...
      <CardContent className="p-4">
        <div className="flex items-start justify-between mb-3">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="font-semibold text-card-foreground">Install ShopEasy</h3>
          </div>
        ...
        <div className="flex space-x-2">
          <Button onClick={handleInstall} size="sm" className="bg-primary hover:bg-primary/90 text-primary-foreground">
            Install
          </Button>
